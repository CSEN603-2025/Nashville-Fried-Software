...
const SideBar: React.FC<SCADStatsProps> = ({ scad, active }) =>
{
    return (
            <div className="link-container">
                <h2>Welcome, SCAD</h2>
                {scad ? <Link className={active == 'Dashboard' ? 'active-link' : 'link'} to="/scaddashboard">Dashboard</Link> : <Link className={active == 'Dashboard' ? 'active-link' : 'link'} to="/facultydashboard">Dashboard</Link>}
                ...
                {scad ? <Link className={active == 'Reports' ? 'active-link' : 'link'} to="/ReportSCAD">Reports</Link> : <Link className={active == 'Reports' ? 'active-link' : 'link'} to="/ReportFaculty">Reports</Link>}
