...
import plusIcon2 from "../../assets/plus.svg";
import  DoneIcon  from "../../assets/donee.svg?react";
              ...
              <div className={styles["profileInfo"]}>
                ...
                <div className={styles["interests-activities-wrapper"]}>
                  <div className={styles["section-box"]}>
                    <h4>
                      ...
                      {isEditingJobInterests ? (<button onClick={() =>
                       ...
                       <DoneIcon className={styles['editty-betty']}/>
                    ...
                    {isEditingJobInterests && (
                      <div className={styles["edit-input"]}>
                        ...
                        >
                          {/* <img src={plusIcon2} color="#3a7bd5" height={20} width={20} /> */}
                          +
                        </button>
                      </div>
                    )}
                  ...
                  <div className={styles["section-box"]}>
                    <h4>
                      College Activities:
                      {isEditingActivities ? (<button onClick={() =>
                        ...
                        <form onSubmit={handleAddInternship}>
                          ...
                          <div className={styles["responses-div"]}>
                            ...
                            {responsibilities.map((responsibility, index) => (
                                ...
                                >
                                <div className={styles["minus-mommy"]}>
                                  <span> &#8722;</span>
                                </div>
                            ...
                            <label>
                              ...
                              >
                                <img src={plusIcon2} width={10} height={10} className={styles['plussy-plus']} alt="" />
                              </button>
                            </label>
